    ...
    public void create(Producto producto) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (Pedido pedidoListPedido : producto.getPedidoList()) {
                Producto oldProductoOfPedidoListPedido = pedidoListPedido.getProducto();
                pedidoListPedido.setProducto(producto);
                pedidoListPedido = em.merge(pedidoListPedido);
                if (oldProductoOfPedidoListPedido != null) {
                    oldProductoOfPedidoListPedido.getPedidoList().remove(pedidoListPedido);
                    oldProductoOfPedidoListPedido = em.merge(oldProductoOfPedidoListPedido);
                }
            }
        ...
        try {
            ...
            for (Pedido pedidoListOldPedido : pedidoListOld) {
                if (!pedidoListNew.contains(pedidoListOldPedido)) {
                    ...
                    illegalOrphanMessages.add("You must retain Pedido " + pedidoListOldPedido + " since its producto field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Pedido pedidoListNewPedido : pedidoListNew) {
                if (!pedidoListOld.contains(pedidoListNewPedido)) {
                    Producto oldProductoOfPedidoListNewPedido = pedidoListNewPedido.getProducto();
                    pedidoListNewPedido.setProducto(producto);
                    pedidoListNewPedido = em.merge(pedidoListNewPedido);
                    if (oldProductoOfPedidoListNewPedido != null && !oldProductoOfPedidoListNewPedido.equals(producto)) {
                        oldProductoOfPedidoListNewPedido.getPedidoList().remove(pedidoListNewPedido);
                        oldProductoOfPedidoListNewPedido = em.merge(oldProductoOfPedidoListNewPedido);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(ProductoPK id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (Pedido pedidoListOrphanCheckPedido : pedidoListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Producto (" + producto + ") cannot be destroyed since the Pedido " + pedidoListOrphanCheckPedido + " in its pedidoList field has a non-nullable producto field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
